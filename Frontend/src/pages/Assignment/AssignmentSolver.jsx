...
5. Maintain a helpful and professional tone`;
  ...
  if (!extractedText) {
    return (
      <div className="min-h-screen bg-blue-950 text-white flex items-center justify-center px-4 pt-24 pb-20">
  ...
  return (
<div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-800 to-blue-950 text-white px-4 pt-24 pb-20 flex flex-col">
  <h1 className="text-4xl font-extrabold text-center mb-4 text-purple-300 drop-shadow">
  ...
  {isLoading ? (
    <div className="flex justify-center items-center text-lg mt-10 text-purple-300 animate-pulse">
      ✍️ Solving your assignment...
    </div>
  ) : (
    <>
      <div className="bg-purple-950/60 p-6 rounded-xl shadow-lg text-sm whitespace-pre-wrap max-h-[70vh] overflow-y-auto font-mono border border-purple-700 mb-6">
        {solution}
      </div>
