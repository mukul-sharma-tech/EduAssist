...
//   return (
// <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-800 to-blue-950 text-white flex items-center justify-center px-6 pt-24 pb-20">
//   <div className="bg-purple-950 p-8 rounded-2xl shadow-2xl w-full max-w-lg border border-purple-800">
//     <h1 className="text-4xl font-extrabold text-center mb-6 text-purple-300">
...
//       onClick={handleUpload}
//       disabled={isLoading}
//       className="w-full bg-purple-600 hover:bg-purple-700 transition duration-200 text-white py-2 px-4 rounded-lg font-semibold disabled:opacity-60"
//     >
